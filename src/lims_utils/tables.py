...
class DataCollection(Base):
    ...
    ScreeningStrategySubWedge: Mapped[
        Optional["ScreeningStrategySubWedge"]
...
class BLSampleImageAutoScoreClass(Base):
    ...
    BLSampleImageAutoScoreSchema: Mapped[
        Optional["BLSampleImageAutoScoreSchema"]
    ] = relationship(
...
class ProcessingPipeline(Base):
    ...
    ProcessingPipelineCategory: Mapped[
        Optional["ProcessingPipelineCategory"]
